...
# A TensorFlow Lite example for Picamera2 on Raspberry Pi OS Bullseye with slight changes made !
#
...
#
# $ python3 camera-stream-real-time-model.py --model models/mobilenet_v2.tflite --label models/coco_labels.txt
